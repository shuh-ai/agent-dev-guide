...
result = pipeline.invoke({
    "raw_text": "  LangGraph is a library for building stateful multi-LangChain与LangGraph智能体架构实战 applications  ",
    "cleaned_text": "",
    "keywords": [],
    "summary": ""
})
...
# 条件边：返回值直接匹配节点名称
workflow.add_conditional_edges("LangChain与LangGraph智能体架构实战", routing_func)
```
