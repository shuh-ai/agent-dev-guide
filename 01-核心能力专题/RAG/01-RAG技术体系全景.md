...
> 本文是 AI 大模型技术社区「RAG 检索增强生成」系列的总览篇，覆盖从基础原理到高阶范式的完整技术链路。
...
![RAG核心技术流程](D:\miaoa\AI\agent-dev-guide\01-核心能力专题\RAG\images\RAG核心技术流程.jpg)
...
![分块策略对比](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/rag/_images/chunking-approaches-by-document-structure.png)

> ▲ 不同文档结构对应的分块策略选择：结构化文档→固定大小，非结构化→基于句子（来源：Microsoft Azure Architecture Center）
...
![混合检索架构](https://superlinked.com/cdn/65dce6831bf9f730421e2915/blog/hybrid-rag-hybridsearch.png)

> ▲ 混合检索流程：Dense 向量检索 + Sparse 关键词检索 → 融合排序 → Top-K 结果（来源：Superlinked）
...
![Bi-Encoder vs Cross-Encoder](https://towardsdatascience.com/wp-content/uploads/2026/04/bi-encoder-vs-cross-encoder-scaled-1.jpg)

> ▲ Bi-Encoder（左）：Query 和 Document 分别编码后计算相似度，速度快但精度有限。Cross-Encoder（右）：Query 和 Document 拼接后联合编码，精度高但速度慢，适合 Rerank 阶段（来源：Towards Data Science）

### 4.4 多路召回

对于复杂检索需求，可以设计多路并行的召回策略，在 Reranker 之前汇合：

![多路召回](D:\miaoa\AI\agent-dev-guide\01-核心能力专题\RAG\images\多路召回.jpg)
...
![GraphRAG 架构](https://datasciencedojo.com/wp-content/uploads/2025/08/Implementing-a-KG-RAG-approach-involves-several-steps-diagram.webp)

> ▲ GraphRAG 的实现流程：知识图谱构建 → 社区检测 → 图遍历检索 → LLM 生成（来源：Data Science Dojo）
...
![Agentic RAG 架构](https://framerusercontent.com/images/5A6No7JDOcGxTpi3UNCHLhfFQk.png)

> ▲ Agentic RAG 系统架构：Agent 自主决策检索策略 → 多轮迭代 → 验证 → 生成（来源：Galileo AI）
...
![Self-RAG 架构](https://selfrag.github.io/static/images/teaser_self_rag_v8.png)

> ▲ Self-RAG 工作流程：左侧为标准 RAG（无自我反思），右侧为 Self-RAG（检索 → 生成 → 反思 → 决定是否重新检索），通过反思 Token 控制全流程（来源：Self-RAG 论文原图）
...
![多模态 RAG Pipeline](https://developer-blogs.nvidia.com/wp-content/uploads/2024/03/rag-preprocessing-for-images.png)

> ▲ 多模态 RAG 的文档预处理流程：分离文本与图片 → 图片分类/描述 → 统一向量化存储（来源：NVIDIA Developer Blog）
...
![RAG技术栈全景图](D:\miaoa\AI\agent-dev-guide\01-核心能力专题\RAG\images\RAG技术栈全景图.jpg)![RAG技术栈全景图](D:\miaoa\AI\agent-dev-guide\01-核心能力专题\RAG\images\RAG技术栈全景图.jpg)



![生产级 RAG 技术栈](https://substackcdn.com/image/fetch/f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9edcef02-29b7-4068-a44b-be0aa1b968d2_1480x943.png)

> ▲ 生产级 RAG 系统架构全景（来源：The Neural Maze）
