...
| 模型 | 输入价格 | 输出价格 | 适用场景 |
|------|----------|----------|----------|
| **DeepSeek R1** | ¥1.0 | ¥4.0 | 推理任务、数学逻辑 |
| **DeepSeek V3** | ¥0.5 | ¥2.0 | 通用任务、高性价比 |
| **Kimi K2** | ¥2.0 | ¥8.0 | 长文本、文档理解 |
...
> - DeepSeek 支持缓存命中，实际成本可降低 80%
> - GPT-5.5 于 2026 年 4 月 24 日发布，Claude Opus 4.8 于 2026 年 5 月 28 日发布
> - Kimi K2 于 2026 年 7 月发布，千问3.7 和 GLM-5 于 2026 年上半年发布
...
2. **国内模型价差 2 倍**：DeepSeek R1 (¥1.0) vs DeepSeek V3 (¥0.5)
3. **跨境价差 70 倍**：GPT-5.5 ($5.00) vs DeepSeek V3 ($0.07)
4. **DeepSeek 性价比最高**：同级别能力下，价格仅为国际模型的 1/10~1/50
...
class TokenMonitor:
    ...
    def calculate_cost(self, model: str, input_tokens: int, output_tokens: int) -> float:
        ...
        pricing = {
            ...
            "deepseek-v3": {"input": 0.5/7.2, "output": 2.0/7.2},
            "deepseek-r1": {"input": 1.0/7.2, "output": 4.0/7.2},
            "kimi-k2": {"input": 2.0/7.2, "output": 8.0/7.2},
