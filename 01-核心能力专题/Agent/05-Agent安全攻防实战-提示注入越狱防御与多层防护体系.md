...
│   ├── 文档投毒（PDF/Word/网页中隐藏恶意指令）
│   ├── 数据库投毒（RAG 检索到被污染的内容）
│   └── 第三方 API 返回恶意指令
├── 多模态注入（Multimodal Injection）
│   └── 图片/音频中嵌入隐藏指令
└── Agent 级注入（Agentic Injection）
    ├── 多 Agent 链式感染
    └── 工具调用劫持
```
...
- [ ] 部署行为监控和异常检测
- [ ] 为所有 Agent 实现最小权限访问控制
- [ ] 将 AI 安全遥测数据集成到 SIEM/SOAR 平台
- [ ] 针对提示注入进行红队演练

### 长期战略（3-12个月）

- [ ] 将 AI 安全嵌入 DevSecOps 流水线
- [ ] 实现 NIST AI RMF 和 ISO 42001 合规
- [ ] 开发 AI 特定的威胁情报能力
- [ ] 建设组织的 AI 安全运营能力
...
| 资源 | 链接 | 说明 |
|------|------|------|
| OWASP Top 10 for LLM 2025 | [owasp.org](https://owasp.org/www-project-top-10-for-large-language-model-applications/) | LLM 应用十大漏洞权威清单 |
| Radware Prompt Injection Guide | [radware.com](https://www.radware.com/cyberpedia/prompt-injection) | 2026年提示注入攻击类型与防御 |
| WorkOS Prompt Injection Defense | [workos.com](https://workos.com/blog/prompt-injection-attacks) | 提示注入防御实战指南 |
| OWASP AI Security Project | [owasp.org](https://owasp.org/www-project-ai-security/) | AI 安全项目主页 |
| NeMo Guardrails | [github.com/NVIDIA](https://github.com/NVIDIA/NeMo-Guardrails) | NVIDIA 的 Agent 护栏框架 |
| LLM Guard | [protectai.com](https://protectai.com/llm-guard) | LLM 输入输出安全扫描 |
| Microsoft Presidio | [github.com/microsoft](https://github.com/microsoft/presidio) | PII 检测与脱敏工具 |
