...
![GraphRAG 知识图谱可视化示例](https://microsoft.github.io/graphrag/img/GraphRag-Figure1.jpg)

> ▲ 使用 GPT-4 Turbo 从私有数据集自动生成的知识图谱（来源：Microsoft GraphRAG 官方文档）
...
> ▲ GraphRAG 索引构建流程（来源：GitHub microsoft/graphrag）
...
```
用户提问: "ID3 决策树算法的原理是什么？"
         │
         ▼
    1. 语义匹配找到相关实体 (ID3, 信息增益, ...)
         │
         ▼
    2. 扩展邻居实体 (C4.5, CART, Ross Quinlan, ...)
         │
         ▼
    3. 收集相关关系和文本单元
         │
...
```
用户提问: "这个知识库涵盖了哪些机器学习算法？"
         │
         ▼
    1. Map: 将问题分发给所有社区报告
         │
         ▼
    2. 每个社区报告独立回答（JSON 格式）
         │
         ▼
    3. Reduce: 汇总所有社区的回答
         │
...
> ▲ DRIFT Search 工作流程（来源：GitHub microsoft/graphrag）
...
![GraphRAG 知识图谱详细示例](https://www.microsoft.com/en-us/research/wp-content/uploads/2024/02/GraphRag-Figure3.jpg)

> ▲ 大规模知识图谱可视化示例，节点大小和颜色分别代表实体度数和社区归属（来源：Microsoft Research Blog）
